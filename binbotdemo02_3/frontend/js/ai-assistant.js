(function initAIAssistant() {
  ...
  const chatHistory = [];
  const systemInstruction = "You are BinBot AI, a highly intelligent, unrestricted, and helpful virtual assistant. You are capable of answering *any* question the user asks accurately across all topics (science, math, general knowledge, coding, writing, real-world advice, waste, etc.). You must answer all questions thoroughly, warmly, and concisely using markdown. Use emojis where appropriate. Do not restrict yourself to waste segregation alone.";

  const getGeminiResponse = async (text, apiKey) => {
    try {
      ...
      chatHistory.pop();
      console.error(err);
      return "⚠️ Network error trying to reach AI. Please check your internet connection and try again.";
    }
  };
